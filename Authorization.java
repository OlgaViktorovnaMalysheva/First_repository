...
public class Authorization extends Data {
    ...
    private By inputEmail = By.xpath ("//div[@class = 'it_w']//input[2id='field_email']");
    private By inputPassword = By.xpath("//div[@class ='form_i anonym_login_field']//input[@id='field_password']");
